# Progresso English Sessions

## Profilo studente
- Nome: Christian
- Lingua madre: Italiano
- Livello attuale: B1
- Obiettivo: Parlare in modo naturale e fluido
- Approccio: ripasso sistematico della grammatica dall'inizio

## Learning Plan
- Monthly focus: Build fluency in everyday conversation while reviewing core grammar
- Weekly theme: Present Simple vs Present Continuous
- Today's micro-goal: Talk about daily routines, swimming, training habits, and future plans
...
- [ ] Condizionali (1°, 2°, 3°)
- [ ] Modali (can, could, must, should, might)
- [ ] Passivo
- [ ] Reported speech
- [ ] Phrasal verbs principali

### Completati
- (nessuno ancora)

## Errori ricorrenti
| Error type | My original sentence | Correction | Times repeated | Last occurrence |
|------------|---------------------|------------|----------------|-----------------|
